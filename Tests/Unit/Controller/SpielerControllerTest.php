...
/**
 * Test case for class Vaupel\Turnierverwaltung\Controller\SpielerController.
 *
 */
class SpielerControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {

	/**
	 * @var \Vaupel\Turnierverwaltung\Controller\SpielerController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('Vaupel\\Turnierverwaltung\\Controller\\SpielerController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllSpielersFromRepositoryAndAssignsThemToView() {
		...
		$spielerRepository = $this->getMock('Vaupel\\Turnierverwaltung\\Domain\\Repository\\SpielerRepository', array('findAll'), array(), '', FALSE);
	...
	public function createActionAddsTheGivenSpielerToSpielerRepository() {
		...
		$spielerRepository = $this->getMock('Vaupel\\Turnierverwaltung\\Domain\\Repository\\SpielerRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenSpielerInSpielerRepository() {
		...
		$spielerRepository = $this->getMock('Vaupel\\Turnierverwaltung\\Domain\\Repository\\SpielerRepository', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenSpielerFromSpielerRepository() {
		...
		$spielerRepository = $this->getMock('Vaupel\\Turnierverwaltung\\Domain\\Repository\\SpielerRepository', array('remove'), array(), '', FALSE);
