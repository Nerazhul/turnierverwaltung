...
$GLOBALS['TCA']['tx_turnierverwaltung_domain_model_spielmodus'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_turnierverwaltung_domain_model_spielmodus']['ctrl'],
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, single, doppel, mixed',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, single, doppel, mixed, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_turnierverwaltung_domain_model_spielmodus.pid=###CURRENT_PID### AND tx_turnierverwaltung_domain_model_spielmodus.sys_language_uid IN (-1,0)',
			),
		),
